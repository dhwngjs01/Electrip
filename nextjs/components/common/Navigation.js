...
function PcNavBar({ pathname, session }) {
  return (
    <Navbar
      className={
...
function AdminNavBar({ pathname, session }) {
  return (
    <>
...
export default function Navigation() {
  ...
  if (pathname.includes("/admin")) {
    return <AdminNavBar pathname={pathname} session={session} />;
  }

  return <PcNavBar pathname={pathname} session={session} />;
}
